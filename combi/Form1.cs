...
namespace combi
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1(String ou, int est, String job)
        {
            InitializeComponent();  
            c = new double[70];
            p = new double[70];
            ...
            var checkPC = new List<CheckBox> { checkBox1, checkBox24, checkBox36, checkBox48,
                checkBox60, checkBox72, checkBox84, checkBox96, checkBox108,
                checkBox120, checkBox12, checkBox18, checkBox30, checkBox42,
                checkBox54, checkBox66, checkBox78, checkBox90, checkBox102, checkBox114 };
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            var groups = new List<GroupBox> { groupBox1, groupBox2, groupBox3, groupBox4, groupBox5, groupBox6, groupBox7,
            groupBox8, groupBox8, groupBox9, groupBox10, groupBox11, groupBox12, groupBox13, groupBox14, groupBox15,
            groupBox16, groupBox17, groupBox18, groupBox19, groupBox20 };
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < h; i++)
            {
                if (c[i] == 0 && u[i] == 1 || c[i] == 0 && u[i] == 2 || c[i] == 0 && u[i] == 3
                || c[i] == 0 && u[i] == 4 || c[i] == 0 && u[i] == 5 || c[i] == 0 && u[i] == 6 ||
                 c[i] == 0 && u[i] == 9)
                {
                    cou++;
