...
namespace combi
{
    public partial class Form2M : Form
    {
        int couu,tt,i,j,n;
        ...
        Form1M o;
        public Form2M(Form1M variables)
        {
            InitializeComponent();
            this.o = variables;
                ...
                foreach (var che in checkC)
                {
                    if (b)
                    {
                        ...
                        if (this.o.C_array[this.o.h].Equals("x"))
                        {
                            ...
                            else { notas[n] = this.o.uuu[this.o.h]; Console.WriteLine(notas[n].ToString() + " notasz"); n++; this.o.h++; acum2--; b = false; }                   
                        }
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            foreach (var check in checksP)
            {
                ...
                if (check.Checked)
                {
                    ...
                    if (j <= 5) { a1 += 1; this.o.u[this.o.h] = 11; }
                    else if (j > 5 && j <= 11) { a2 += 1; this.o.u[this.o.h] = 12; }
                    else if (j > 11 && j <= 17) { a3 += 1; this.o.u[this.o.h] = 13; }
                    else if (j > 17 && j <= 23) { a4 += 1; this.o.u[this.o.h] = 14; }
                    else if (j > 23 && j <= 29) { a5 += 1; this.o.u[this.o.h] = 15; }
                    else if (j > 29 && j <= 35) { a6 += 1; this.o.u[this.o.h] = 16; }
                    else if (j > 35 && j <= 41) { a7 += 1; this.o.u[this.o.h] = 17; }
                    else if (j > 41 && j <= 47) { a8 += 1; this.o.u[this.o.h] = 18; }
                    else if (j > 47 && j <= 53) { a9 += 1; this.o.u[this.o.h] = 19; }
                    else if (j > 53 && j <= 59) { a10 += 1; this.o.u[this.o.h] = 20; }
                    this.o.h++;
                }
                if (i == 5)
                {
            ...
            {
                if (this.o.c[i] == 0 && this.o.u[i] == 16 || this.o.c[i] == 0 && this.o.u[i] == 17 || this.o.c[i] == 0 && this.o.u[i] == 19
                 || this.o.c[i] == 0 && this.o.u[i] == 20)
                {
                    this.o.cou++;
