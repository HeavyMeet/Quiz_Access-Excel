...
namespace combi
{
    ...
    public partial class Form4M : Form
    {
        ...
        Form1M o;
        public Form4M(Form1M variables)
        {
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            foreach (var check in checksP)
            {
                ...
                if (check.Checked)
                {
                    ...
                    if (j <= 5) { a1 += 1; this.o.u[this.o.h] = 31; }
                    else if (j > 5 && j <= 11) { a2 += 1; this.o.u[this.o.h] = 32; }
                    else if (j > 11 && j <= 17) { a3 += 1; this.o.u[this.o.h] = 33; }
                    else if (j > 17 && j <= 23) { a4 += 1; this.o.u[this.o.h] = 34; }
                    else if (j > 23 && j <= 29) { a5 += 1; this.o.u[this.o.h] = 35; }
                    else if (j > 29 && j <= 35) { a6 += 1; this.o.u[this.o.h] = 36; }
                    else if (j > 35 && j <= 41) { a7 += 1; this.o.u[this.o.h] = 37; }
                    else if (j > 41 && j <= 47) { a8 += 1; this.o.u[this.o.h] = 38; }
                    else if (j > 47 && j <= 53) { a9 += 1; this.o.u[this.o.h] = 39; }
                    else if (j > 53 && j <= 59) { a10 += 1; this.o.u[this.o.h] = 40; }
                    this.o.h++;
                }
                if (i == 5)
                {
