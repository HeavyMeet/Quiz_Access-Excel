...
namespace combi
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            var etiquetas = new List<Label> { label4,label7,label1,la,lab, prop,cons };
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            {
                if (this.o.c[i] == 0  && this.o.u[i] == 16 || this.o.c[i] == 0  &&
                    this.o.u[i] == 17 || this.o.c[i] == 0  && this.o.u[i] == 19
