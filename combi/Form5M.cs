...
namespace combi
{
    ...
    public partial class Form5M : Form
    {
        ...
        public Form5M(Form1M variables)
        {
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            foreach (var check in checksP)
            {
                ...
                if (check.Checked)
                {
                    ...
                    if (j <= 5) { a1 += 1; this.o.u[this.o.h] = 41; }
                    else if (j > 5 && j <= 11) { a2 += 1; this.o.u[this.o.h] = 42; }
                    else if (j > 11 && j <= 17) { a3 += 1; this.o.u[this.o.h] = 43; }
                    else if (j > 17 && j <= 23) { a4 += 1; this.o.u[this.o.h] = 44; }
                    else if (j > 23 && j <= 29) { a5 += 1; this.o.u[this.o.h] = 45; }
                    else if (j > 29 && j <= 35) { a6 += 1; this.o.u[this.o.h] = 46; }
                    else if (j > 35 && j <= 41) { a7 += 1; this.o.u[this.o.h] = 47; }
                    else if (j > 41 && j <= 47) { a8 += 1; this.o.u[this.o.h] = 48; }
                    else if (j > 47 && j <= 53) { a9 += 1; this.o.u[this.o.h] = 49; }
                    else if (j > 53 && j <= 59) { a10 += 1; this.o.u[this.o.h] = 50; }
                    this.o.h++;
                }
                if (i == 5)
                {
            ...
            {
                if (this.o.c[i] == 0 && this.o.u[i] == 46 || this.o.c[i] == 0 && this.o.u[i] == 48 || this.o.c[i] == 0 && this.o.u[i] == 49
                || this.o.c[i] == 0 && this.o.u[i] == 50)
                {
                    this.o.cou++;
                }
            }
