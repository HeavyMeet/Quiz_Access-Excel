...
namespace combi
{
    public partial class Form3M : Form
    {
        int couu, tt, i, j, n;
        ...
        public Form3M(Form1M variables)
        {
                ...
                foreach (var che in checkC)
                {
                    if (b)
                    {
                        if (this.o.C_array[this.o.h].Equals("x"))
                        {
                            ...
                            Console.WriteLine(notas[n-1].ToString());
                        }
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            foreach (var check in checksP)
            {
                ...
                if (check.Checked)
                {
                    ...
                    if (j <= 5) { a1 += 1; this.o.u[this.o.h] = 21; }
                    else if (j > 5 && j <= 11) { a2 += 1; this.o.u[this.o.h] = 22; }
                    else if (j > 11 && j <= 17) { a3 += 1; this.o.u[this.o.h] = 23; }
                    else if (j > 17 && j <= 23) { a4 += 1; this.o.u[this.o.h] = 24; }
                    else if (j > 23 && j <= 29) { a5 += 1; this.o.u[this.o.h] = 25; }
                    else if (j > 29 && j <= 35) { a6 += 1; this.o.u[this.o.h] = 26; }
                    else if (j > 35 && j <= 41) { a7 += 1; this.o.u[this.o.h] = 27; }
                    else if (j > 41 && j <= 47) { a8 += 1; this.o.u[this.o.h] = 28; }
                    else if (j > 47 && j <= 53) { a9 += 1; this.o.u[this.o.h] = 29; }
                    else if (j > 53 && j <= 59) { a10 += 1; this.o.u[this.o.h] = 30; }
                    this.o.h++;
                }
                if (i == 5)
                {
            ...
            {
                if (this.o.c[i] == 0 && this.o.u[i] == 21 || this.o.c[i] == 0 && this.o.u[i] == 23
                || this.o.c[i] == 0 && this.o.u[i] == 24 || this.o.c[i] == 0 && this.o.u[i] == 25 || this.o.c[i] == 0 && this.o.u[i] == 26)
                {
                    this.o.cou++;
                }
            }
