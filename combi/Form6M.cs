...
namespace combi
{
    ...
    public partial class Form6M : Form
    {
        int couu, tt, i, j, n;
        ...
        Form1M o;
        public Form6M(Form1M variables)
        {
        ...
        private void siguiente_Click(object sender, EventArgs e)
        {
            ...
            foreach (var check in checksP)
            {
                ...
                if (check.Checked)
                {
                    ...
                    if (j <= 5) { a1 += 1; this.o.u[this.o.h] = 51; }
                    else if (j > 5 && j <= 11) { a2 += 1; this.o.u[this.o.h] = 52; }
                    else if (j > 11 && j <= 17) { a3 += 1; this.o.u[this.o.h] = 53; }
                    else if (j > 17 && j <= 23) { a4 += 1; this.o.u[this.o.h] = 54; }
                    else if (j > 23 && j <= 29) { a5 += 1; this.o.u[this.o.h] = 55; }
                    else if (j > 29 && j <= 35) { a6 += 1; this.o.u[this.o.h] = 56; }
                    else if (j > 35 && j <= 41) { a7 += 1; this.o.u[this.o.h] = 57; }
                    else if (j > 41 && j <= 47) { a8 += 1; this.o.u[this.o.h] = 58; }
                    else if (j > 47 && j <= 53) { a9 += 1; this.o.u[this.o.h] = 59; }
                    else if (j > 53 && j <= 59) { a10 += 1; this.o.u[this.o.h] = 60; }
                    this.o.h++;
                }
                if (i == 5)
                {
            ...
            {
                if (this.o.c[i] == 0 && this.o.u[i] == 51 || this.o.c[i] == 0 && this.o.u[i] == 52 || this.o.c[i] == 0 && this.o.u[i] == 54
         || this.o.c[i] == 0 && this.o.u[i] == 58 || this.o.c[i] == 0 && this.o.u[i] == 59 || this.o.c[i] == 0 && this.o.u[i] == 60)
                {
                    this.o.cou++;
                }
            }
